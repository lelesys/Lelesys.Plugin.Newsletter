...
class Version20140403130605 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_category (persistence_object_identifier VARCHAR(40) NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8  ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_recipient_abstractgroup (persistence_object_identifier VARCHAR(40) NOT NULL, title VARCHAR(255) NOT NULL, dtype VARCHAR(255) NOT NULL, PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8  ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_recipient_group_party (persistence_object_identifier VARCHAR(40) NOT NULL, PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8  ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_recipient_group_st_59daa (persistence_object_identifier VARCHAR(40) NOT NULL, recipientlist VARCHAR(255) NOT NULL, PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8  ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_recipient_person (persistence_object_identifier VARCHAR(40) NOT NULL, gender TINYINT(1) NOT NULL, acceptshtml TINYINT(1) DEFAULT NULL, PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8  ENGINE = InnoDB");
