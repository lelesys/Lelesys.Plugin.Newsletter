...
class Version20140403130605 extends AbstractMigration {
	...
	public function up(Schema $schema) {
        ...
        $this->addSql("ALTER TABLE lelesys_plugin_newsletter_domain_model_recipient_person ADD CONSTRAINT FK_91D644BB47A46B0A FOREIGN KEY (persistence_object_identifier) REFERENCES neos_party_domain_model_abstractparty (persistence_object_identifier) ON DELETE CASCADE");
		...
		$this->addSql("ALTER TABLE lelesys_plugin_newsletter_domain_model_n_11124_attachments_join ADD CONSTRAINT FK_8631FD5FD708A4C4 FOREIGN KEY (media_document) REFERENCES neos_media_domain_model_document (persistence_object_identifier)");
