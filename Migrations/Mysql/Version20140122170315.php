 ...
 */
class Version20140122170315 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_emaillog (persistence_object_identifier VARCHAR(40) NOT NULL, timecreated DATETIME NOT NULL, timesent DATETIME NOT NULL, recipienttype VARCHAR(255) NOT NULL, recipient VARCHAR(255) NOT NULL, issent TINYINT(1) NOT NULL, isfailed TINYINT(1) NOT NULL, PRIMARY KEY(persistence_object_identifier)) ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_emaillog_newsletter_join (newsletter_emaillog VARCHAR(40) NOT NULL, newsletter_newsletter VARCHAR(40) NOT NULL, INDEX IDX_EAA56DB49C4EAA56 (newsletter_emaillog), INDEX IDX_EAA56DB49390BC62 (newsletter_newsletter), PRIMARY KEY(newsletter_emaillog, newsletter_newsletter)) ENGINE = InnoDB");
		...
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_recipient_group_st_59daa (persistence_object_identifier VARCHAR(40) NOT NULL, recipientlist VARCHAR(255) NOT NULL, PRIMARY KEY(persistence_object_identifier)) ENGINE = InnoDB");
		...
		$this->addSql("ALTER TABLE lelesys_plugin_newsletter_domain_model_emaillog_newsletter_join ADD CONSTRAINT FK_EAA56DB49C4EAA56 FOREIGN KEY (newsletter_emaillog) REFERENCES lelesys_plugin_newsletter_domain_model_emaillog (persistence_object_identifier)");
		$this->addSql("ALTER TABLE lelesys_plugin_newsletter_domain_model_emaillog_newsletter_join ADD CONSTRAINT FK_EAA56DB49390BC62 FOREIGN KEY (newsletter_newsletter) REFERENCES lelesys_plugin_newsletter_domain_model_newsletter (persistence_object_identifier)");
	...
	public function down(Schema $schema) {
		...
		$this->addSql("ALTER TABLE lelesys_plugin_newsletter_domain_model_emaillog_newsletter_join DROP FOREIGN KEY FK_EAA56DB49C4EAA56");
		$this->addSql("ALTER TABLE lelesys_plugin_newsletter_domain_model_emaillog_newsletter_join DROP FOREIGN KEY FK_EAA56DB49390BC62");
		...
		$this->addSql("DROP TABLE lelesys_plugin_newsletter_domain_model_emaillog_newsletter_join");
